...
export function getLodop (oOBJECT, oEMBED) {
  var strHtmInstall = "<br><font color='#FF00FF'>打印控件未安装!点击这里<a href='CLodop_Setup_for_Win32NT.zip' target='_self'>执行安装</a>,安装后请刷新页面或重新进入。</font>"
  ...
  var strCLodopInstall_1 = "<div style='padding:20px;background:#fff;position:relative;z-index:9999999'><font color='#FF00FF'>Web打印服务CLodop未安装启动，点击这里<a href='http://192.168.50.62:6060/upload/CLodop_Setup_for_Win32NT.exe' target='_self'>下载执行安装</a>"
